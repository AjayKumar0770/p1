...
// ==========================================
// 1. DETERMINISTIC SEED DATA GENERATOR
// ==========================================
...
export interface Stock {
  ...
  low52Week: number;
  beta: number;
  // Pre-calculated indicator snapshots (seeded)
  sma50: number;
  sma200: number;
  ema12: number;
  ema26: number;
...
// ==========================================
// 2. GEOMETRIC BROWNIAN MOTION SIMULATOR
// ==========================================
...
simulator.addListener((updates: TickUpdate[]) => {
